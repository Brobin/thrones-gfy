...
gfycats = {
    'Arya': {
        'Bloody Gate Laugh': 'http://gfycat.com/BadLivelyChital',
    ...
    'Cersei': {
        ...
        'More Wine': 'http://gfycat.com/ViciousVerifiableFlickertailsquirrel',
    },
    'Daario': {
    ...
    'Daenerys': {
        '360 Jorahscope': 'http://gfycat.com/CookedOpulentEchidna',
        'Drogon': 'http://gfycat.com/TinyRegularBrahmancow',
        'Mereen': 'http://gfycat.com/AnguishedYawningIndianglassfish',
        'Eye Roll': 'http://gfycat.com/VerifiableUnrulyCow',
        'Dracarys': 'http://gfycat.com/BlondViciousCavy',
    ...
    'Hodor': {
        'Hodor': 'http://gfycat.com/AccomplishedRegularIndianskimmer',
        'Hodor!': 'http://gfycat.com/UnsteadyJauntyEmperorshrimp',
    },
    'Hound': {
        'Bring Me Wine': 'http://gfycat.com/PeskyPleasingDungenesscrab',
        'Bloody Gate Laugh': 'http://gfycat.com/BadLivelyChital',
        'To Pass the Bloody Gate': 'http://gfycat.com/ElasticCraftyGilamonster',
    },
    'Jamie': {
    ...
    'Jaqen': {
        ...
        'Deal With It': 'http://gfycat.com/UnimportantHomelyFrilledlizard',
    },
    'Joffrey': {
    ...
    'Petyr': {
        'Deal With It': 'http://gfycat.com/GoodForkedAfricanclawedfrog',
    },
    'Ramsay': {
    ...
    'Tywin': {
        ...
        'You\'re too smart': 'http://gfycat.com/HeavenlySeveralIlsamochadegu',
    },
    'Walder Frey': {
        'Walder Clap': 'http://gfycat.com/MasculineUnfitGlobefish'
    },
    'White Walker': {
        'Winter is Coming': 'http://gfycat.com/ClearcutSharpGoose',
...
LI = '<li><a href="%s" title="%s" class="gif">%s</a></li>'


output = '<ul>'
for character, gfys in sorted(gfycats.iteritems()):
    output += '<li>%s<ul>' % character
    for title, link in gfys.iteritems():
        title = title.title()
        output += LI % (link, title, title)
    output += '</ul></li>'
output += '</ul>'


with open('index.html', 'w+') as output_file:
    with open('template/header.html') as header:
        output_file.write(header.read())
    output_file.write(output)
    with open('template/footer.html') as footer:
        output_file.write(footer.read())
